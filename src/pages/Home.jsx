    ...
    <div className="max-w-5xl mx-auto px-6  items-center gap-10 mt-5">
        <div className="bg-gray-200 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl grid md:grid-cols-2 transition-shadow m-px mb-3">
                <p className="text-left">Lunes a viernes: </p> <h1 className="text-right text-blue-700">8:00AM - 5:00PM</h1>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl grid md:grid-cols-2 transition-shadow m-px mb-3">
                <p className="text-left">Sabado: </p> <h1 className="text-right text-blue-700">9:00AM - 2:00PM</h1>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl grid md:grid-cols-2 transition-shadow m-px mb-3">
                <p className="text-left">Domingo: </p> <h1 className="text-right text-gray-400">Cerrado</h1>
            </div>
